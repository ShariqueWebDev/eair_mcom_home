...
const projects: Project[] = [
...

  {
    ...
    description:
      "Our Data Center Solutions offer a comprehensive infrastructure that includes virtualized servers, storage, and network resources—designed for agility, scalability, and enhanced security. We also provide advanced power management systems with modular monitoring, battery backup, and capacity planning to ensure uninterrupted operations. Ideal for modern businesses, our solutions support seamless service delivery and future-ready IT infrastructure.",
...
export default function ScrollWeb() {
  return (
    <section className="flex flex-col gap-5 lg:gap-10 min-h-screen pb-16">
      ...
      <div className="mx-auto max-w-8xl w-full px-6 lg:px-8">
        <div className="grid md:grid-cols-12 gap-6">
          <div className="md:col-start-2 md:col-span-10 flex flex-col gap-8 md:gap-8">
            {projects.map((project, index) => (
              <div key={index} className="relative">
                ...
                >
                  <div className="w-full md:w-1/3">
                    <div className="lg:sticky pt-6 top-16 md:-mt-6">
                      {/* Text Content */}
                      <div className="pb-6">
                        <h4 className="mb-4 sm:text-xl md:text-xl text-base font-semibold">
                          {project.title1}
                        </h4>
                        <ul className="list-disc list-inside text-sm mb-6 text-gray-700">
                          {project.points1.map((point, i) => (
                            <li key={i}>{point}</li>
                          ))}
                        </ul>
                        ...
                        {project.title2 && (
                          <>
                            <h4 className="mb-4 md:text-xl text-xl font-semibold">
                              {project.title2}
                            </h4>
