...
const OurClients = () => {
  return (
    <div className="templateContainer  text-center py-8 lg:py-14 heading-all space-y-10 bg-white ">
      <div className="space-y-3">
        <h2
          data-aos="fade-up"
          className="text-center text-gray-800 font-semibold text-3xl lg:text-4xl tracking-wide"
        >
