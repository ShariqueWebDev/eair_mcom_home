...
const FeaturesWeb: React.FC = () => {
  ...
  return (
    <section className="relative h-[90vh] overflow-hidden py-20 lg:pb-24 xl:pb-28">
      {/* Background Image */}
      ...
      <div className="relative mx-auto max-w-6xl px-4 md:px-8">
        <div className="flex flex-col md:flex-row items-center gap-8 lg:gap-16">
          ...
          <div className="md:w-1/2 animate-slide-right md:order-last">
            <h4 className="font-medium uppercase text-gray-900 dark:text-white flex items-center gap-4">
              <span className="inline-flex bg-[#313087] text-white text-sm px-4 py-1 rounded-full">
                New
              </span>
              features
            </h4>
